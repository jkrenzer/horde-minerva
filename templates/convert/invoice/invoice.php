...
<td width="50%">
    <h2><?php echo _('Invoice'); ?>: <?php echo $this->invoice_name; ?></h2>
    <br />
    <br />
</td>
</tr>
...
<tr valign="top">
    ...
    <td><?php echo $this->invoice_service; ?></td>
</tr>
<tr valign="top">
...
<table style="float: right; border-collapse: collapse;" align="right">
<tr valign="top">
...
<?php if ($this->banks): ?>
<?php echo _('The invoice is payable on the bank account of'); ?>
<?php $i4 = count($this->banks); foreach ($this->banks as $k4 => $v4): ?>
 <?php echo $v4; ?>
<?php if (--$i4 != 0) { echo _(" or "); }; endforeach; ?>
<br />
<?php endif; ?>
<?php echo _('Use the invoice number for the transaction reference.'); ?> 
</p>

<p class="small" style="text-align: justify;"> 
Zaračunavamo zamudne obresti in tečajno razliko po določilih o pogojih 
poslovanja. Eventualna reklamacija ne zadrži plačila nespornega dela računa. Do 
končnega plačila ostane vso blago v lasti našega podjetja oziroma vam ni 
dolžno opraviti katerokoli drugo storitev vezano s tem ali drugim dogovorom. 
</p> 

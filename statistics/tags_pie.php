<?php
/**
 * Minerva tags pie statistic
 *
 * TODO: Round values per Horde_Currencies fact digits
 *
 * $Horde: incubator/minerva/statistics/tags_pie.php,v 1.12 2009/11/09 19:58:38 duck Exp $
 *
...
if ($form->validate()) {
    ...
    foreach ($data as $tag => $total) {
        $Datasets[0]->addPoint($tags[$tag], ($total/$sum)*100);
        $r = rand(128, 255);
        $g = rand(128, 255);
        $b = rand(128, 255);

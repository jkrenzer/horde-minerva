 ...
 *
 * $Horde: incubator/minerva/list/download.php,v 1.26 2009/11/09 19:58:37 duck Exp $
 *
...
if ($form->validate()) {
    ...
    if (empty($info['invoices'])) {
        ...
        header('Location: ' . Horde::applicationUrl('list/download.php'));
        exit;
    }
...
echo $tabs->render();
$form->renderActive(null, null, Horde::applicationUrl('list/download.php'), 'post');

 ...
 *
 * $Horde: incubator/minerva/list/send.php,v 1.34 2009/11/09 19:58:37 duck Exp $
 *
...
if ($form->validate()) {
    ...
    if (empty($info['invoices'])) {
        ...
        header('Location: ' . Horde::applicationUrl('list/send.php'));
        exit;
    }
...
echo $tabs->render();
$form->renderActive(null, null, Horde::applicationUrl('list/send.php'), 'post');
